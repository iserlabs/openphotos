  ...
  return (
    <div className="mx-auto w-full max-w-2xl flex-1 px-6 py-16">
      ...
      <div className="mt-6 space-y-4 text-zinc-300">
        <p>
          OpenPhotos is an opt-in photography hub built on the AT Protocol, the
          ...
          OpenPhotos reads those public records to assemble a dedicated feed,
        ...
        <p>
          OpenPhotos indexes public posts and records — mainly image posts
